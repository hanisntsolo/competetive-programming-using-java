...
//        }
//        // if(DEBUG)
//            // out.print( Arrays.deepToString(matrix) + "\n");
//        ArrayList<StringBuilder> numList = new ArrayList<>();
//        for(int i = 0; i < a; i++) {
//            for(int j = 0; j < b; j++) {
//                if(matrix[i][j] == '#') {
//                    numList.add(new StringBuilder(String.valueOf(i+""+j)));
//                }
//            }
//        }
//        // for(int[] num : numList) {
...
//        // }
//        ArrayList<StringBuilder> numList2 = new ArrayList<>();
//        for(int i = 0; i < a; i++) {
//            for(int j = 0; j < b; j++) {
//                if(matrix[i][j] == '#') {
//                    numList2.add(new StringBuilder(String.valueOf(j+""+i)));
//                }
//            }
//        }
//        if(DEBUG) {
...
//            out.print( numList2 + "\n");
//        }
//        int index = (int)Math.floor(numList.size()/2);
//        StringBuilder result = numList.get(index);
//        String[] nums = result.toString().split("");
//        StringBuilder strBuilder = new StringBuilder();
//        for(String num : nums) {
//            strBuilder.append(Integer.parseInt(num) + 1);
//            strBuilder.append(" ");
//        }
//        out.print(strBuilder.substring(0,3) + "\n");
//    }
