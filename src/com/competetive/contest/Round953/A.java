...
//     * 1 2 | 3 # 5
//     */
//    // two containers to track pile => Priority Queue Problem
//    public static void solve() {
//        // code goes here//
//        int totalBooks = fs.nextInt();
//        PriorityQueue<Book> pq1 = new PriorityQueue<Book>(5, new BookComparator());
//        PriorityQueue<Book> pq2 = new PriorityQueue<Book>(5, new BookComparator());
//        for(int i = 1; i <= totalBooks; i++) {
//            int pages = fs.nextInt();
//            Book book = new Book(i, pages);
//            if(pq1.isEmpty()) {
//                pq1.offer(book);
//                continue;
//            } else if (pq2.isEmpty()) {
...
//        out.print( pq2 + "\n");
//        }
//        out.print(atP1.pages + atP2.pages + "\n");
//    }
//    static class Book {
//        private int number;
//        private int pages;
//        Book(int number, int pages) {
//            this.number = number;
//            this.pages = pages;
//        }
//        @Override
//        public String toString() {
//            return "Book : number "+ this.number + "pages" + this.pages;
//        }
//    }
...
//        // Check if the password contains only lowercase Latin letters and digits
...
//        String letters = password.replaceAll("[^a-z]", "");
//        if (!letters.equals(letters.chars()
//            .sorted()
//            .collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append)
//            .toString())) {
//            return false;
...
//        return true;
//    }
//    private static boolean matchesAny(String password, String... regexes) {
