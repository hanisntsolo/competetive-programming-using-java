...
//        // code goes here//
//        int len = fs.nextInt();
//        int previousGuy = fs.nextInt(); // 37
//        int nextGuy = fs.nextInt(); // 8
//        int previousMax = Math.max(previousGuy, nextGuy); //37
//        int maxGuy = Math.max(nextGuy, previousMax); //37
//        while(len > 2) {
//            previousGuy = nextGuy;
//            nextGuy = fs.nextInt();
//            maxGuy = Math.max(previousGuy, nextGuy);
//            previousGuy = nextGuy;
//            if(maxGuy < previousMax) {
//                previousMax = maxGuy;
//            }
//            len-- ;
//        }
//        out.print( previousMax - 1 + "\n");
//    }
