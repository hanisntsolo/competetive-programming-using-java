...
//            System.out.println(longestCommonSubsegmentLengthB(x, y));
//        }
//
//        scanner.close();
//    }
//
//    public static BigInteger longestCommonSubsegmentLengthB(BigInteger x, BigInteger y) {
//        BigInteger z = x.xor(y);  // Calculate the XOR difference
//        int maxLen = 0;
//        int currentLen = 0;
//
//        // Iterate through the bits of z
//        while (z.compareTo(BigInteger.ZERO) > 0) {
//            if (z.and(BigInteger.ONE).equals(BigInteger.ZERO)) {
//                currentLen++;
...
//                currentLen = 0;
//            }
//            z = z.shiftRight(1);  // Right shift z by 1
//        }
//
//        // Return the length of the longest common subsegment
//        return BigInteger.ONE.shiftLeft(maxLen); // 2^maxLen using bitwise shift
//    }
//
//    public static long longestCommonSubsegmentLength2(long x, long y) {
//        long z = x ^ y;  // Calculate the XOR difference
//        long maxLen = 0;
//        long currentLen = 0;
//
//        // Iterate through the bits of z
...
//                currentLen = 0;
//            }
//            z >>= 1;  // Right shift z by 1
//        }
//
//        // Return the length of the longest common subsegment
//        return 1L << maxLen; // 2^maxLen using bitwise shift
//    }
//    public static long longestCommonSubsegmentLength1(long x, long y) {
//        long z = x ^ y;  // Calculate the XOR difference
//        long maxLen = 0;
//        long currentLen = 0;
//
...
//
//        // Return the length of the longest common subsegment
//        return (long) Math.pow(2, maxLen); // 2^maxLen
//    }
//    public static long lcll(long x, long y) {
//        long z = x ^ y;
//        int maxLen = 0;
//        int currentLen = 0;
...
//            }
//        }
//        return (long) Math.pow(2, maxLen);
//    }
//
//    public static int longestCommonSubsegmentLength(int x, int y) {
//        long z = x ^ y;  // Calculate the XOR difference
//        int maxLen = 0;
//        int currentLen = 0;
//        out.print( x + " " + Integer.toBinaryString(x) + "\n");
//        out.print( y + " " + Integer.toBinaryString(y) + "\n");
//        out.print( "x ^ y " +  Long.toBinaryString(z) + "\n");
//        // Iterate through the bits of z
//        for (int i = 0; i < Long.SIZE; i++) {
//            if ((z & (1L << i)) == 0) {
//                currentLen++;
...
//        Map<Integer, Integer> aFrequency = new HashMap<>();
//        Map<Integer, Integer> bFrequency = new HashMap<>();
//
//        // Populate frequency map for a
//        for (int num : a) {
//            aFrequency.put(num, aFrequency.getOrDefault(num, 0) + 1);
//        }
//
//        // Populate frequency map for b
//        for (int num : b) {
...
//        int operations = 0;
//
//        // Calculate operations needed to match frequencies
//        for (Map.Entry<Integer, Integer> entry : bFrequency.entrySet()) {
//            int num = entry.getKey();
//            int freqInB = entry.getValue();
//            int freqInA = aFrequency.getOrDefault(num, 0);
//
//            if (freqInB > freqInA) {
//                operations += (freqInB - freqInA);
//            }
//        }
//
//        return operations;
