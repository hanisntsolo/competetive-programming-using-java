...
public class B {
    ...
    */
    ...
    public static void solve() {
        ...
        // int lastElementinB = b[n];
        // int diffAbs = Math.abs(lastElementinB - a[0]);
        // for(int i = 0; i < n; i++) {
        //     int newDiffAbs = Math.abs(lastElementinB - a[i]);
        //     if(newDiffAbs <= diffAbs) {
        //         a[n] = a[i];
        //     }
        // }
        ...
        // long minOps = 0;
        // boolean flag = true;
        // // Try matching each element of b[n + 1] as the element that was appended to 'a'
        // for (int j = 0; j <= n; j++) {
        //     if(flag && (a[j] - b[j]) <= b[n] && b[n] <= a[j]) {
        //         flag = false;
        ...
        //     }
        //     minOps += Math.abs(a[j] - b[j]);
        // }
        // out.print( (int) minOps + "\n");
        out.print( minOperations(a, b) + "\n");
    }
