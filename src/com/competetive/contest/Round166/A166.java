...
public class A166 {
    ...
    */
    ...
    public static void solve() {
        ...
        // if(matcher.matches()) {
        //     pattern = Pattern.compile(noDigitAfterALetter);
        //     matcher = pattern.matcher(password);
        //     if(matcher.matches()) {
        //         pattern = Pattern.compile(digitIncreasingStrictly);
        //         matcher = pattern.matcher(password);
        //         if(matcher.matches()) {
        //             pattern = Pattern.compile(letterIncreasingStrictly);
        //             matcher = pattern.matcher(password);
        //             if(matcher.matches()) {
        //                 out.print( "YES" + "\n");
        //                 if(DEBUG) {
        //                     out.print( "letterIncreasingStrictly" + "\n");
        //                 }
        //             } else {
        //                 out.print( "NO" + "\n");
        //                 if(DEBUG) {
        //                     out.print( "letterNotIncreasingStrictly" + "\n");
        //                 }
        //             }
        //         } else {
        //             out.print( "NO" + "\n");
        //             if(DEBUG) {
        //                 out.print( "digitNotIncreasingStrictly" + "\n");
        //             }  
        //         }
        //     } else {
        //         out.print( "NO" + "\n");
        //         if(DEBUG) {
        //             out.print( "noDigitAfterALetterCase" + "\n");
        //         }   
        //     }
        // } else {
        //     out.print( "NO" + "\n");
        //     if(DEBUG) {
        //         out.print( "lowerCaseLatin" + "\n");
        //     }   
        // }
    }
