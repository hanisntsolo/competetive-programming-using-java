...
//        int blocks = fs.nextInt();
//        int shower = fs.nextInt();
//        int minutes = fs.nextInt();
//        int[][] timeSlots = new int[blocks][2];
//        for (int i = 0; i < blocks; i++ ) {
//            timeSlots[i][0] = fs.nextInt();
//            timeSlots[i][1] = fs.nextInt();
//        }
//        if(shower == 0) {
//            out.print( "YES" + "\n");
//            return;
