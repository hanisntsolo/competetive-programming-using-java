...
//    }
//    private static int win(int a, int b, int c, int d) {
//        int winA = 0;
//        int winB = 0;
//        if(a > b) winA++;
//        if(a < b) winB++;
//        if(c > d) winA++;
//        if(c < d) winB++;
//        return winA > winB ? 1 : 0;
//    }
//    public static void solve() {
//        int a1 = fs.nextInt(), a2 = fs.nextInt(), b1 = fs.nextInt(), b2 = fs.nextInt();
//        out.print(
//            win(a1, b1, a2, b2) + win(a1, b2, a2, b1) + win(a2, b1, a1, b2) + win(a2, b2, a1, b1)
//         + "\n");
//    }
//
