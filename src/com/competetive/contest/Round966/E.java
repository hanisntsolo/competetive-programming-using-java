...
//                totalOperations += calculateOperations(num);
//            }
//
//            out.println(totalOperations);
//    }
//    private static int calculateOperations(int x) {
//        int operations = 0;
//        while (x > 0) {
//            operations++;
//            x = (x + 2) / 3; // This reduces x to the next number needed to be zero
//        }
//        return operations;
//    }
//        public static int calculateOperations(int l, int r) {
//        int[] count = new int[3];
//        for (int i = l; i <= r; i++) {
//            count[i % 3]++;
//        }
...
//
//        // Iterate to find the least operations needed
//        for (int base = 0; base < 3; base++) {
//            int x = count[base];
//            int y = count[(base + 1) % 3];
//            int z = count[(base + 2) % 3];
//
//            int currentOperations = 0;
//            while (y > x) {
//                currentOperations += y - x;
//                x = y;
//                y = (y + 2) / 3;
//            }
//            currentOperations += (2 * z + 2 * x + y) / 3;
//
...
//    }
//    public static int calculateMinimumOperations(int l, int r) {
//        int n = r - l + 1; // Total numbers
//        int[] modCount = new int[3];
//
//        // Count numbers in each modulo class
//        for (int i = l; i <= r; i++) {
//            modCount[i % 3]++;
//        }
//
//        // Extract the count of each group
//        int zeros = modCount[0];
//        int ones = modCount[1];
//        int twos = modCount[2];
//
//        // Minimum operations needed using the modulo count
//        int operations = 0;
//
//        // Pair (1, 2) to make zero, each pair costs 1 operation
//        int pairs = Math.min(ones, twos);
//        operations += pairs;
//
//        // Remaining 1s and 2s after pairing
//        ones -= pairs;
//        twos -= pairs;
//
//        // Every group of 3 ones can be reduced to zero in 2 operations
//        operations += (ones / 3) * 2;
//        // Every group of 3 twos can be reduced to zero in 2 operations
//        operations += (twos / 3) * 2;
//
//        // Handle any remaining 1s or 2s by using extra operations
//        ones %= 3;
//        twos %= 3;
//
//        // If we have leftover ones or twos, it will cost extra
//        if (ones > 0 || twos > 0) {
//            operations += 2;
//        }
//
//        // Use all zeros effectively by pairing within themselves
//        operations += (zeros / 3) * 2 + (zeros % 3);
//
//        return operations;
//    }
//
