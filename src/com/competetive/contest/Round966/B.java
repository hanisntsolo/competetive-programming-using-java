...
//        List<Boolean> busSeat = new ArrayList<>(Collections.nCopies((int)seats + 10, false));
//        ArrayList<Integer> list = new ArrayList<>();
//        while(seats > 0) {
//            list.add(fs.nextInt());
//            seats--;
//        }
//        busSeat.set(list.get(0), true);
//        for(int i = 1; i < list.size(); i++) {
//            int person = list.get(i);
//            if(busSeat.get(person + 1) || busSeat.get(person - 1)) {
//                busSeat.set((int)person, true);
//            } else {
//                out.print( "NO" + "\n");
//                return;
//            }
