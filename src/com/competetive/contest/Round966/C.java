...
//    /**
//     *Day has m minutes
//     * takes s minutes to shower.
//     * n is the number of intervals alex has planned.
//     *
//     */
//    private static boolean sameLen(List<BigInteger> len, String s) {
//        return len.size() == s.length();
//    }
//    private static boolean checkCorrespondence1(List<BigInteger> list, String s) {
//        Map<Character, BigInteger> map = new HashMap<>();
//        for(int i = 0; i < s.length(); i++) {
//            if(!map.containsKey(s.charAt(i))) {
//                map.put(s.charAt(i), list.get(i));
//            } else {
//                // Check if the mapping is same else return
//                if(!map.get(s.charAt(i)).equals(list.get(i))) {
//                    return false;
//                }
//            }
//        }
//        return true;
//    }
//    private static boolean checkCorrespondence2(String s, List<BigInteger> list) {
//        Map<BigInteger, Character> map = new HashMap<>();
//        for(int i = 0; i < list.size(); i++) {
//            if(!map.containsKey(list.get(i))) {
//                map.put(list.get(i), s.charAt(i));
//            } else {
//                // Check if the mapping is same else return
//                if(!map.get(list.get(i)).equals(s.charAt(i))) {
//                    return false;
//                }
//            }
//        }
...
//        for(int i = 0; i < len; i++) {
//            list.add(new BigInteger(fs.next()));
//        }
//        long strings = fs.nextLong();
//        while(strings > 0) {
//            String s = fs.next();
//            if(sameLen(list, s) && checkCorrespondence1(list, s) && checkCorrespondence2(s, list)) {
//                out.print( "YES" + "\n");
//            } else {
//                out.print( "NO" + "\n");
//            }
