...
public class SegmentTree {
    ...
    */
    ...
    public static void solveDirect() throws IOException {
        ...
        BuildSegmentTreeForSumRangeQuery segmentTree = new BuildSegmentTreeForSumRangeQuery(len);
        segmentTree.build(arr, 1, 0, len - 1);
        out.print(segmentTree.sum(1, 0, len - 1, 3, 4) + "\n");
