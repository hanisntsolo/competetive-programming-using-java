...
public class PetyaAndStrings {
    static class Reader {
        ...
        public static int compareStrings(StringBuilder first, StringBuilder second) {
...
//                Reader sc = new Reader();
                ...
                StringBuilder first = new StringBuilder(sc.next().toLowerCase());
                StringBuilder second = new StringBuilder(sc.next().toLowerCase());
                out.println(compareStrings(first,second));
        }
