...
public class CFBWinner {
    ...
    */
    ...
    public static void solve() {		
        // code goes here//
        PriorityQueue<Map.Entry<String, Integer>> mergedQueue = new PriorityQueue<>(
        ...
        for(int i = 1; i <= n; i++) {
        	String name = fs.next();
        	int roundVal = fs.nextInt();
        	// if(roundVal < 0) continue;
        	addToMergedQueue(roundMap, mergedQueue, name, roundVal);
        	// out.print("ROUND: " + i + "::"+ roundMap + "\n");
        }
        Map.Entry<String, Integer> entry = mergedQueue.poll();
        out.print(entry.getKey() + "\n");	

        // for(Map.Entry<String, Integer> entry1 : mergedQueue) {
        // 	out.print(entry1.getKey() + "::" + entry1.getValue()  + "\n");
        // 	// break;
        // }
    }
    // Helper method to add or merge entries in the queue and map
    static void addToMergedQueue(Map<String, Integer> map, PriorityQueue<Map.Entry<String, Integer>> queue, String key, int value) {
        ...
        if (!added) {
            queue.add(new AbstractMap.SimpleEntry<>(key, map.get(key)));
        }
    }
