    ...
    */
    ...
    public static void solveDirect() throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            // Check if the domino has one even and one odd number
            if ((xi % 2 != yi % 2)) {
                hasOddEvenPair = true;
            }
        }
        ...
        if (sumUpper % 2 == 0 && sumLower % 2 == 0) {
            out.print( 0 + "\n"); // No rotation needed
        } else if (sumUpper % 2 != 0 && sumLower % 2 != 0 && hasOddEvenPair) {
            out.print( 1 + "\n"); // One rotation will solve the issue
        } else {
