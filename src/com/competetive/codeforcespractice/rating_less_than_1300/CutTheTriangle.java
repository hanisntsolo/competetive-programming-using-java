...
public class CutTheTriangle {
    ...
    */
    ...
    static double dist(int x1, int y1, int x2 , int y2) {
    	...
    	return (double)Math.sqrt((Math.abs(x1 - x2)*Math.abs(x1 - x2)) + (Math.abs(y1 - y2)*Math.abs(y1 - y2)));
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(test > 0) {
            //Write code here;
        	// Take input and calculate all three distances//
        	int a1 = fs.nextInt(), a2 = fs.nextInt();
