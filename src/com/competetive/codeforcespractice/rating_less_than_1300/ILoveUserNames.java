...
public class ILoveUserNames {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(operate(list));
	}
	public static int operate(ArrayList<Integer> list) {
		int worstPerformance = list.get(0);
		int bestPerformance = list.get(0);
		int amazingPerformance = 0;
		for(int i = 1; i < list.size(); i++) {
			int currentPerformance = list.get(i);
