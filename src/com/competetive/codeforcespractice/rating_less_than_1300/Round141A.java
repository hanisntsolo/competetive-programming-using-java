    ...
    */
    ...
    public static void solve() {
        ...
        for(int i = 0; i < array.length; i++) {
        	int val = isBeautiful(sum, array, i);
        	// out.print( val + "\n");
        	if(val == -1) {
        		out.print( "YES" + "\n");
        		for(int k : array) { out.print( k + " ");}
        		return;
        	} else if (val == array.length - 1) {
        		out.print("NO");
        		return;
        	} else {	
        			swap(array, val, array.length - 1);
        	}
        }
        out.print("NO");
    }
	static int isBeautiful(int sum, int[]array, int index) {
	...
	static void swap(int[] array, int currIndex, int nextIndex) {
