    ...
    public static void main(String[] args) throws IOException {
        ...
        while(test > 0) {
            ...
            if(len <= 2) {
            	...
            	//Check if the moujntain contains valley;
        		for(int i = 0; i < range.length - 2; i++) {
        			int[] possibleValley = {range[i], range[i+1], range[i+2]};
        			if(possibleValley[0] >= possibleValley[1] && possibleValley[1] <= possibleValley[2]) {
        				flag = true;
        				out.print( "YES" + "\n");
        				break;
        			}
        			if(i == 0 && possibleValley[0] >= possibleValley[1] ) {
        				flag = true;
        				out.print( "YES" + "\n");break;
        			}
        			if(i == range.length - 1 && possibleValley[1] <= possibleValley[2]) {
        				flag = true;
        				out.print( "YES" + "\n");break;
        			}
        		}
