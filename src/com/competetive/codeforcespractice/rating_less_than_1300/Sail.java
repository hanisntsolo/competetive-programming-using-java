    ...
    */
    ...
    public static void solve() {
        ...
        while(time-- > 0) {
        	...
        	if(Character.getNumericValue(wind.charAt(index)) == Character.getNumericValue(xDirection)) {
        		--movesX;
        	} else if(Character.getNumericValue(wind.charAt(index)) == Character.getNumericValue(yDirection)) {
        		--movesY;
        	}
        	++sec;
        	index++;
