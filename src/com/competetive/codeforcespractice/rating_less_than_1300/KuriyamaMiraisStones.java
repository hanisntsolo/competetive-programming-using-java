...
public class KuriyamaMiraisStones {
  ...
  public static void solveDirect() throws IOException {
        ...
        for(int i = 0; i < len; i++) {
        	...
        	list.add(num);sortedList.add(num);
        }
        ...
        long totalSortedSum = 0L;
        for(int i = 0 ; i < len; i++ ){
        	totalSortedSum+=sortedList.get(i);
        	sortedList.set(i,totalSortedSum);
        }
        if(DEBUG == false) {
        	out.print( list + "\n");
        ...
        for (int i = 0; i < questions; i++) {
        	...
        	if(type == 1) {
        		if(l == 1) {
        			out.print(list.get(r - 1) + "\n");
        		} else {
        			out.print(list.get(r - 1) - list.get(l - 2)  + "\n");
        		}
        	} else {
        		if(l == 1) {
        			out.print(sortedList.get(r - 1) + "\n");
        		} else {
        			out.print(sortedList.get(r - 1) - sortedList.get(l - 2)  + "\n");
        		}
        	}
        }
    }
