...
public class Twins {
    ...
    */
    ...
    public static void solve() {
        int len = fs.nextInt();
        // if only one coin take it to maximize your take
        if(len == 1) {
        	out.print( len + "\n");
        	return;
        }
        ...
        long totalCoinSum = 0;
        //else go over the other coins to maximize your take.
        for (int i = 0; i < len; i++) {
        	int currCoin = fs.nextInt();
        	totalCoinSum += currCoin;
        	coins.add(currCoin);
        }
        ...
        for (int i = len - 1; i >= 0; i--) {
        	...
        	totalCoinSum -= currCoin;
        	totalCoinsTaken++;
        	if(myTake > totalCoinSum) {
        		out.print( totalCoinsTaken + "\n");
        		return;
        	}
        }
    }
