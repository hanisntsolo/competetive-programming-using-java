...
public class Games {
    ...
    */
    ...
    public static void solve() {
        ...
        int[][] uniformColor = new int[teams][2];
        for (int i = 0; i < teams; ++i) {
        	uniformColor[i][0] = fs.nextInt();
        	uniformColor[i][1] = fs.nextInt();
        }
        int matches = 0;
        // mapping is unique so we are covered with the edge cases.
        for(int rowGuestColor = 0; rowGuestColor < teams; ++rowGuestColor ) {
        	int rowGuestColorNum = uniformColor[rowGuestColor][1];
        	for(int rowHomeColor = 0; rowHomeColor < teams; ++rowHomeColor) {
        		if(uniformColor[rowHomeColor][0] == rowGuestColorNum) {
        			matches++;
        		}
        	}
        }
